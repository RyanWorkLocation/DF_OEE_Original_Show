       ...
       //     }
            ...
            return new ActionResponse<OEEOverView>
            {
                ...
                (
                    ...
                    oEE: new OEERate(Math.Round(82.3d*80.4d*95.8d/10000, 2), 60d),
                    availbility: new AvailbilityRate(82.3d, 70d),
                    performance: new PerformanceRate(80.4d, 97d),
                    yield: new YieldRate(95.8d, 95d),
                    delivery: new DeliveryRate(85.2d, 97d)
                )
            };
        }
        ...
        public ActionResponse<List<OEEOverViewHistory>> Get(int days)
        {
            ...
            var OEEtemp = double.MinValue;
            var availbilitytemp = double.MinValue;
            var performancetemp = double.MinValue;
            var yieldtemp = double.MinValue;
            var deliverytemp = double.MinValue;
            for (int i = 0; i < days; i++)
            {
                ...
                if (isWeekend)
                {
                    // Set all values to 0 for weekend days
                    availbilitytemp = 0;
                    performancetemp = 0;
                    yieldtemp = 0;
                    deliverytemp = 0;
                ...
                {
                    // Original calculation for weekdays
                    availbilitytemp = Math.Round(75d + 20 * random.NextDouble(), 2);
                    performancetemp = Math.Round(75d + 20 * random.NextDouble(), 2);
                    yieldtemp = Math.Round(75d + 20 * random.NextDouble(), 2);
                    deliverytemp = Math.Round(75d + 20 * random.NextDouble(), 2);
                    OEEtemp = Math.Round(availbilitytemp * performancetemp * yieldtemp / 10000, 2);
                }
                ...
                (
                    ...
                    oeeOverView: new OEEOverView
                    (
                        oEE: new OEERate(OEEtemp, 70d),
                        availbility: new AvailbilityRate(availbilitytemp, 90d),
                        performance: new PerformanceRate(performancetemp, 80d),
                        yield: new YieldRate(yieldtemp, 95d),
                        delivery: new DeliveryRate(deliverytemp, 95d)
                    )
                ));
            }
